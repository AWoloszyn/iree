...
void iree_queue_initialize(iree_queue_t* queue,
...
iree_status_t iree_queue_push_back(iree_queue_t* queue,
                                             void* element) {
  // Expand
...
void iree_queue_pop_front(iree_queue_t* queue,
...
void* iree_queue_at(iree_queue_t* queue,
                              iree_host_size_t i) {
  IREE_ASSERT_ARGUMENT(queue);
