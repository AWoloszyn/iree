...
#ifndef IREE_HAL_DRIVERS_HIP_MULTI_QUEUE_COMMAND_BUFFER_H__
#define IREE_HAL_DRIVERS_HIP_MULTI_QUEUE_COMMAND_BUFFER_H__
...
#endif  // IREE_HAL_DRIVERS_HIP_MULTI_QUEUE_COMMAND_BUFFER_H__
