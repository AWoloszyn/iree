...
hipCtx_t iree_hal_hip_device_group_device_context(iree_hal_device_t* device);
...
iree_hal_hip_device_group_device_dynamic_symbols(iree_hal_device_t* device);
...
// is void*.
static inline iree_device_size_t
iree_hal_hip_device_group_device_ptr_to_device_size(hipDeviceptr_t p) {
  return (uintptr_t)p;
}
static inline hipDeviceptr_t
iree_hal_hip_device_group_device_size_to_hip_device_prt(iree_device_size_t p) {
